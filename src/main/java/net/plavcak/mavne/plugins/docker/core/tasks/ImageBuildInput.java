...
public class ImageBuildInput {
    ...
    public ImageBuildInput setSquash(boolean squash) {
        this.squash = squash;
        return this;
    }
    ...
    public ImageBuildInput setTarget(String target) {
        this.target = target;
        return this;
    }
    ...
    public ImageBuildInput setRm(boolean rm) {
        this.rm = rm;
        return this;
    }
    ...
    public ImageBuildInput setUlimit(String ulimit) {
        this.ulimit = ulimit;
        return this;
    }
}
